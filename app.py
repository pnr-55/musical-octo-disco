...
hospitals_data = {
    ...
    "กิโลเมตรเจ็ดสิบเจ็ด": ["โรงพยาบาลชุมชน"], "สตูล": ["โรงพยาบาลสตูล"], "สมุทรปราการ": ["โรงพยาบาลสมุทรปราการ"], "สมุทรสงคราม": ["โรงพยาบาลสมเด็จพระพุทธเลิศหล้า"], 
...
# รวบรวมรายชื่อจังหวัดทั้งหมด เรียงตามตัวอักษรเพื่อความง่ายในการหา
...
if menu == "🧬 [01] PATIENT INFRASTRUCTURE":
    ...
    with st.form("reg_form"):
        ...
        st.markdown("---")
        st.markdown("##### 🏥 TELEMEDICINE NODE ROUTING (เลือกเครือข่ายจังหวัดและโรงพยาบาลส่งต่อ)")
        
        # กล่องเลือกจังหวัดชั้นที่ 1
        ...
        # ดึงรายชื่อโรงพยาบาลเฉพาะของจังหวัดนั้น ๆ ขึ้นมาให้เลือกในชั้นที่ 2
    ...
    if submit_button:
        if name:
            ...
            st.success(f"📟 LINKED SUCCESS: ลงทะเบียนคุณ {name} เรียบร้อย! ปลายทาง: {hospital} จ. {selected_province}")
        else:
