...
# ==========================================
    ...
    if st.session_state.user_data is None or st.session_state.analysis_result is None:
        ...
        if angle < 130:
            ...
            st.markdown("""
            <div style='background-color: rgba(255,159,67,0.25); border: 2px solid #ff9f43; padding: 18px; border-radius: 8px;'>
                <h4 style='color: #ff9f43; margin: 0; font-weight: bold;'>⚠️
