...
st.markdown("<p style='text-align: center; color: #6c757d; font-family: monospace; font-size: 14px;'>MULTI-AXIS ALIGNMENT INFERENCE ENGINE // VERSION 7.6</p>", unsafe_allow_html=True)
...
if menu == "📌 [01] บันทึกประวัติและอาการ":
    ...
    with st.form("reg_form"):
        ...
        # กล่องเลือกจังหวัด (ตั้งค่าเริ่มต้นให้เป็น ลพบุรี เพื่อความง่ายในการทดสอบของหนู)
        ...
        # ดึงรายชื่อโรงพยาบาลของจังหวัดที่เลือกมาแสดงผลตรง ๆ ห้ามสลับ!
